...
abstract class EditUserTopViewValidator implements IValidator {
    public static function validate(array $data) {
        ...
        if (strlen($data['check_in_message']) > DataValidationConfig::CHECK_IN_MESSAGE_MAX_LENGTH)
            $errMsgs['checkInMessage'] = '<label class="form_label_error" for="check_in_message" id="form_label_error_check_in_message">Voer een geldige check-in boodschap in.</label>';
