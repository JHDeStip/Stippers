...
abstract class SessionCleanup implements IMiddleware {
    ...
    public static function run(array $requestData) {
        ...
        if ($requestData['requestedPage'] != 'manageuser' && $requestData['requestedPage'] != 'downloadsearchresults')
        ...
        if ($requestData['requestedPage'] != 'manageusermoney')
            unset($_SESSION['Stippers']['ManageUserMoney']);
