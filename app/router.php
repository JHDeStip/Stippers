...
switch ($requestData['requestedPage']) {
    ...
    case 'edituser':
        ...
        break;
    case 'downloadsearchresults':
        require_once('controllers/downloadSearchResults/DownloadSearchResultsController.php');
        $controller = 'DownloadSearchResultsController';
        break;
