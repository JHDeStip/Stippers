...
abstract class ProfileTopViewValidator implements IValidator {
    public static function validate(array $data) {
        ...
        if (!$data['phone'] == '' && !preg_match('/^[0-9]{'.DataValidationConfig::PHONEMINLENGTH.','.DataValidationConfig::PHONEMAXLENGTH.'}$/', $data['phone']))
