 ...
 * 
 * This file contains code to validate a form and to enable or disable it's controls.
 */
...
function enableControls(form) {
    ...
    saveButton.setAttribute('id', 'profile_form_save');
    ...
    cancelButton.setAttribute('id', 'profile_form_cancel');
...
function disableControls(form) {
    ...
    element = document.getElementById('profile_form_save');
    if (element) {
        element.parentNode.removeChild(element);
    }
    
    element = document.getElementById('profile_form_cancel');
    if (element) {
        element.parentNode.removeChild(element);
    }
    ...
    editButton.setAttribute('id', 'profile_form_edit');
