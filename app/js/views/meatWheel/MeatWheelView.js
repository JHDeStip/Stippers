...
var items = ['Cervela', 'Curryworst', 'Berenhap', 'Bitterballen', 'Picknicker', 'Boulet', 'Chickenfingers', 'Sitostick', 'Saté', 'Mexicano', 'Viandel'];
...
function addWedge(n) {
    ...
    var wedge = new Konva.Group({
        rotation: 2 * n * Math.PI / items.length,
    });
...
function init() {
    ...
    wheel = new Konva.Group({
        x: document.getElementById('container').offsetWidth / 2,
        y: 450
    });
